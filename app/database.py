...
def save_stats(filename, url, stats):
    with get_db_connection() as con:
        ...
        import json
        con.execute("""
            INSERT INTO image_stats (id, filename, upload_time, width, height, mean_color_r, mean_color_g, mean_color_b, url, hog_features, metadata_analysis, art_medium_analysis, summary, ai_probability, fd_default)
