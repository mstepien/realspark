...
#   timestamp: 2026-01-22T14:31:39+00:00
...
class TaskStatus(BaseModel):
    status: str = Field(
        ...,
        description='Current status (Starting..., Preprocessing..., Performing Parallel Analysis..., Saving to Database..., Complete, Error, Abandoned)',
    )
    progress: int
    steps: list[str]
