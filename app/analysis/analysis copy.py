...
def compute_fractal_stats(np_image):
    ...
    """
    # resized_img = np_image
    # # if resized_img.width > 1024 or resized_img.height > 1024:
    # #     resized_img = resize(np_image, (1024, 1024), anti_aliasing=True)
    ...
    fd_default = fractal_dimension(np_image)
